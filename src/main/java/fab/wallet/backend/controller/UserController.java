...
public class UserController {
	...
	@RequestMapping(value = "/fab/authenticate", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public Response fetchUsers(@RequestBody Request request, HttpServletRequest httpRequest,
			HttpServletResponse response) throws Exception {
		return userService.authenticateUser(request);
	}
	
	@RequestMapping(value = "/fab/purchase", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
